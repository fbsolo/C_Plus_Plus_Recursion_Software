...
int main() {
	...
	innerRecLambda = [&innerRecLambda, &pfObj](int x[]) {
	...
	outerRecLambda = [&outerRecLambda, &innerRecLambda, &pfObj](int x[]) {
	...
	std::cout << "\tx[1] = " << finishedValues[1] << " --> gen_pentnum(x[1]) = gen_pentnum(" << finishedValues[1] << ") = " << pfObj.gen_pentnum(finishedValues[1]) << "\n";
	std::cout << "\tx[0] = " << finishedValues[0] << " --> gen_pentnum(x[0]) = gen_pentnum(" << finishedValues[0] << ") = " << pfObj.gen_pentnum(finishedValues[0]) << "\n\n";
	std::cout << "\t\t\tgen_pentnum(x[1]) + gen_pentnum(x[0]) = " << pfObj.gen_pentnum(finishedValues[1]) + pfObj.gen_pentnum(finishedValues[0]) << "\n";
	std::cout << "\t\t\tgen_pentnum(" << finishedValues[1] << ") + gen_pentnum(" << finishedValues[0] << ") = " << pfObj.gen_pentnum(finishedValues[1]) + pfObj.gen_pentnum(finishedValues[0]) << "\n\n";
